        ...
        <section className="relative overflow-hidden bg-linear-to-b from-background ">
            <div className="wrapper">
                <div className="flex flex-col items-center justify-center lg:py24 py-12 text-center">
                    ...
                    <h1 className="text-5xl text:sm-6xl lg:text-7xl font-bold tracking-tight mb-6 max-w-5xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-16">
                        ...
                        >
                            <Link href="/submit">
                                <SparkleIcon className="size-5" />Share Your Project
                            </Link>
                        </Button>
                        <Button 
                            asChild 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8sm:gap-12 max-w-2xl w-full">
                        {statsData.map((stat) => (
